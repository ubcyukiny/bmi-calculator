...
const Tips = () => {
  return (
    <section className='flex flex-col py-14 pr-7 px-5 gap-10 bg-gradient-to-r from-[rgba(214,252,254,0)] to-[rgba(214,230,254,100)] h-auto md:px-10 md:gap-10'>
      <div className=' flex flex-col gap-8 md:flex md:flex-row md:gap-10 md:items-center'>
