...
const ResultsMeaning = () => {
  return (
    <section className='lg:px-36 lg:gap-20 lg:pb-24 2xl:justify-center lg:pt-16 flex flex-col pt-[440px] gap-12 pb-[4.5rem] sm:flex-row md:pt-44 sm:pr-10 sm:pt-72 sm:pb-24'>
      <img
        src={eatingPic}
        alt=''
        className='w-full sm:w-1/2 sm:ml-[-3rem] object-cover lg:max-w-[600px]'
      />
